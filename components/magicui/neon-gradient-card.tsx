...
interface NeonGradientCardProps {
  ...
  imageSrc?: string; // Accept local image path
  [key: string]: any;
}
...
const NeonGradientCard: React.FC<NeonGradientCardProps> = ({
  ...
  const [dimensions, setDimensions] = useState({ width: 400, height: 230 }); // Default dimensions
  ...
  return (
    <div
      ...
      className={cn(
        "relative z-10 h-[230px] w-[400px] rounded-[var(--border-radius)]", // Default dimensions
        className,
      )}
      {...props}
    >
